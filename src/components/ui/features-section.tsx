...
export const FeaturesSection = () => {
    ...
    return (
        <section className="relative w-full py-20 sm:py-28 md:py-36 px-5 sm:px-8">
            <div className="absolute w-[500px] h-[500px] rounded-full bg-[#10B981]/[0.015] blur-[120px] top-[30%] left-[5%] pointer-events-none" />
            ...
            <div ref={revealRef} className="max-w-6xl mx-auto relative">
                ...
                <div data-reveal className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-white/[0.025] rounded-2xl overflow-hidden border border-white/[0.025]">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="bg-[#050505] p-5 sm:p-6 md:p-7 group hover:bg-[#10B981]/[0.015] transition-all duration-500"
                        >
                            <feature.icon className="w-4 h-4 sm:w-5 sm:h-5 text-[#10B981]/40 mb-4 sm:mb-5 group-hover:text-[#10B981] transition-colors duration-500" />
